...
{
  /// <summary>
  /// Adapter Plugin for SimConnect 2020
  /// 
  ///  Delta to 2024
  ///    SIMCONNECT_ICAO.Ident String length 9 vs 6
  ///    
  ///    SIMCONNECT_DATA_FACILITY_AIRPORT.Ident String length 9 vs 6
  ///    
  ///    SIMCONNECT_DATA_FACILITY_WAYPOINT.Ident String length 9 vs 6
  ///       SIMCONNECT_DATA_FACILITY_AIRPORT.Ident String length 9 vs 6
  ///       
  ///    SIMCONNECT_DATA_FACILITY_NDB.Ident String length 9 vs 6
  ///       SIMCONNECT_DATA_FACILITY_WAYPOINT.Ident String length 9 vs 6
  ///           SIMCONNECT_DATA_FACILITY_AIRPORT.Ident String length 9 vs 6
  ///           
  ///    SIMCONNECT_DATA_FACILITY_VOR.Ident String length 9 vs 6
  ///       SIMCONNECT_DATA_FACILITY_NDB.Ident String length 9 vs 6
  ///         SIMCONNECT_DATA_FACILITY_WAYPOINT.Ident String length 9 vs 6
  ///             SIMCONNECT_DATA_FACILITY_AIRPORT.Ident String length 9 vs 6
  ///             
...
#pragma warning restore CS0168 // Variable is declared but never used
    ...
    {
      _simConnect?.ReceiveDispatch( (FS.SignalProcDelegate)pfcnSignal );
    }
    */
    ...
    // added in 2024 SDK 1.1.2 but not supported in FS2020 - returns an Exception 
